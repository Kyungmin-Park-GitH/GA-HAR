"""Training utilities for evaluating genomes on the HAR datasets with 2 sensors (LSTM)."""
...
from .model_lstm_2 import HARLSTMNet2Sensor
...
def _create_dataloader_2sensor(
    ...
    """Creates a PyTorch DataLoader for 2 sensors."""
