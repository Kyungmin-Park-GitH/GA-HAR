"""Training utilities for evaluating genomes on the HAR datasets with 2 sensors (CNN)."""
...
from .model_cnn_2 import HARConvNet2Sensor
...
def _create_dataloader_2sensor(
    ...
    """Creates a PyTorch DataLoader from numpy arrays for 2 sensors."""
...
def evaluate_with_kfold(
    ...
    """Evaluates the genome using stratified K-fold cross validation with 2 sensors."""
