"""Multi-objective genetic algorithm (NSGA-II) for 2-sensor hybrid CNN-LSTM HAR model search."""
...
from .training_hybrid_2 import EvaluationMetrics, TrainingConfig, evaluate_with_kfold
    ...
    def log_generation(self, generation: int, individuals: Sequence[Individual]) -> None:
        ...
        for rank_index, individual in enumerate(sorted_individuals, start=1):
            ...
            for dataset in self.datasets:
                ...
                confusion_row_prefix = [generation, rank_index, None]
