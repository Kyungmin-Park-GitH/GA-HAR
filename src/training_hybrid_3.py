"""Training utilities for evaluating genomes on the HAR datasets with 3 sensors (Hybrid)."""
...
from .model_hybrid_3 import HARHybridNet3Sensor
...
def train_with_validation(
    ...
    model = HARHybridNet3Sensor(
        ...
        kernel_size=config.kernel_size, lstm_layers=config.lstm_layers,
